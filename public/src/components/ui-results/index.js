		...
		return (
			<section className="results">
				...
				<div className="remote-results">
					<h2>
						Suggestions
						{ ( ! isNil(this.props.suggestions.totalResults)
								? <span className="new badge"><strong>{this.props.suggestions.totalResults}</strong> résultat{ ( 1 < this.props.suggestions.totalResults ? 's' : '' ) }</span>
								: ''
						) }
					</h2>
